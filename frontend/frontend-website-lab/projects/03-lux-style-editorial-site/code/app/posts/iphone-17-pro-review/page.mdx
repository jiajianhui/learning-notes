...
<div className='flex justify-start items-end h-120 md:h-screen w-screen mb-10 px-6 md:px-20 lg:px-40 bg-[url("/iphone-17-pro-review/images/hero.png")] bg-cover bg-center bg-no-repeat'>
  <h2 className='max-w-4xl pb-10 md:pb-20 text-5xl md:text-7xl font-black text-white'>iPhone 17 Pro Camera Review: Rule of Three</h2>
</div>
...
<div className='w-full flex flex-col gap-1.5 lg:gap-2.5 items-center px-6 lg:px-0 mb-10 lg:mb-20'>
  <div className='w-full lg:w-4xl grid grid-cols-3 gap-1.5 lg:gap-2.5'>
  ...
  <div className='w-full lg:w-4xl grid grid-cols-2 gap-1.5 lg:gap-2.5'>
...
<div className='h-100 lg:h-screen w-screen mb-10 bg-[url("/iphone-17-pro-review/images/016-Screenshot-2025-09-24-at-12.19.50---PM.png")] bg-cover bg-center bg-no-repeat'>
