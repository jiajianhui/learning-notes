...
```text
基础 -> TypeScript -> React/Vue 思想 -> React/Vue 最小语法 -> Vite -> Router/Store 概念 -> Router/Store 最小语法 -> Next/Nuxt
```
...
读完第 11 章后，如果想进一步理解 `package.json`、公开入口、打包内容和版本发布，再选读 [11A-npm 包制作与发布](./11A-从使用npm包到制作并发布npm包.md)。它是工程化选修，不增加新的配套项目，也不影响继续阅读第 12 章。
